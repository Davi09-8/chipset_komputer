...
export default function NewProductPage() {
    ...
    function handleSpecChange(index: number, field: 'key' | 'value', value: string) {
    ...
    return (
        <div className="p-6 max-w-4xl">
            <div className="mb-6">
                ...
                <h1 className="text-2xl font-bold mt-2">Tambah Produk Baru</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div>
                    ...
                    <div className="mt-2 text-sm">
                        <div className="flex items-center text-gray-500">
                            <span className="mr-2">URL: .../product/</span>
                            <span className="font-mono bg-gray-100 px-2 py-1 rounded">
                                {formData.slug || 'nama-produk-anda'}
                            </span>
                            <button
                                type="button"
                                onClick={() => setShowSlug(!showSlug)}
                                className="ml-3 text-indigo-600 hover:text-indigo-800 text-xs underline"
                            >
                                {showSlug ? 'Sembunyikan' : 'Edit URL'}
                            </button>
                        </div>
                        ...
                        {showSlug && (
                            <div className="mt-2">
                                <input
                                    ...
                                    value={formData.slug}
                                    onChange={handleChange}
                                    className="w-full px-3 py-1 border rounded text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
                    ...
                    <div className="space-y-3 bg-gray-50 p-4 rounded-lg border">
                        {specs.map((spec, index) => (
                            <div key={index} className="flex gap-3">
                                <input
                                    type="text"
                                    placeholder="Label (contoh: Processor)"
                                    value={spec.key}
                                ...
                                <input
                                    type="text"
                                    placeholder="Value (contoh: Intel Core i9)"
                                    value={spec.value}
                        ...
                        {specs.length === 0 && (
                            <p className="text-sm text-gray-400 text-center py-2">Belum ada spesifikasi</p>
                        )}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        placeholder="CPU-INTEL-I9-13900K"
                    />
                </div>
